...
/* ── plant feature grid (the reference card's "Features" block) ─────────── */

type FeatureIcon = 'sun' | 'drop' | 'ruler' | 'home' | 'sprout' | 'paw';
type PlantFeature = { key: string; title: string; label: string; icon: FeatureIcon };
...
function plantFeatures(product: Product): PlantFeature[] {
